...
# docker run -it --rm -u $(id -u):$(id -g) -v $(pwd):/temp -w /temp python:3.8 pip3 install pillow -t .
#
# run as:
# docker run -it --rm -u $(id -u):$(id -g) -v $(pwd):/temp -w /temp python:3.8 python3 test_local.py
